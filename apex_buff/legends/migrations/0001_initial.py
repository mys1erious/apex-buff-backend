    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', cloudinary.models.CloudinaryField(blank=True, default='no_image', max_length=255, verbose_name='image')),
                ('icon_imgf', models.ImageField(default='no_image', upload_to='legends/types/')),
